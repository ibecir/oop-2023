...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        if (coffeeBox instanceof MaxWeightBox) {
            ...
            System.out.println(maxWeightBox.isInTheBox(new Thing("Pirkka")));
            System.out.println(maxWeightBox.isInTheBox(new Thing("Kopi Luwak")));
        }
        ...
        if (box instanceof OneThingBox) {
            ...
            System.out.println(oneThingBox.isInTheBox(new Thing("Pirkka")));
        }
        ...
        if (blackHoleBox instanceof BlackHoleBox) {
            ...
            System.out.println(bhBox.isInTheBox(new Thing("Saludo")));
            System.out.println(bhBox.isInTheBox(new Thing("Pirkka")));
        } */
    }
}
